...
![GitHub last commit (by committer)](https://img.shields.io/github/last-commit/Diegodiogotsil/java)
![GitHub](https://img.shields.io/github/license/Diegodiogotsil/java)
![GitHub repo size](https://img.shields.io/github/repo-size/Diegodiogotsil/java)


# gerador de numeros de loterias
## Primeiro projeto em c# para gerar números de loteria
